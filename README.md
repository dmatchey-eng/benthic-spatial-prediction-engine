...
* **🛡️**[![CodeQL Actions Status](🛡️)](https://github.com/dmatchey-eng/benthic-spatial-prediction-engine/actions/workflows/codeql.yml)
* **💻**[![Modern C++ Standard](💻)](https://cppreference.com)
* **🏷️**[![Release Version](🏷️)](https://github.com/dmatchey-eng/benthic-spatial-prediction-engine/releases)
